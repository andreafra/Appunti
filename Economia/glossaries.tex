...
\newglossaryentry{mercato}{
	name={mercato},
	description={luogo (fisico o virtuale) dove avvengono le contrattazioni per la vendita e l'acquisto di beni e
		servizi e dove si incontrano clienti (consumatori) e imprese (produttori)}
}

\newglossaryentry{consumatori}{
	name={consumatori},
	description={agenti economici disposti a pagare per acquistare dei beni o servizi}
}

\newglossaryentry{utilita}{
	name={utilità},
	description={misura della soddisfazione che si ricava dal consumo di beni e servizi, rappresentata dalla
funzione di utilità}
}

\newglossaryentry{microstruttura}{
	name={Microstruttura},
	description={Insieme di mansioni e ruoli assegnabili ad un'unica persona}
}

\newglossaryentry{compito}{
	name={Compito},
	description={Insieme di attività o operazioni necessariamente collegate
		in funzione di proprietà/capacità del lavoro umano e
		tecnica impiegata.}
}

\newglossaryentry{mansione}{
	name={Mansione},
	description={L’insieme dei compiti elementari assegnabili ad una
		posizione aziendale che può essere ricoperta da una
		persona.}
}

\newglossaryentry{macrostruttura}{
	name={Macrostruttura},
	description={Insieme di unità organizzative costituenti l'organizzazione
		nel suo complesso.}
}
